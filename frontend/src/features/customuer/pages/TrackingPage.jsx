        ...
        <section className="mx-auto text-center tracking-shell">
          ...
          {!isLoading && shipment ? (
            <div className="tracking-results mt-4 mt-md-5 text-end">
              ...
              <div className="card border-0 tracking-result-card tracking-qr-card mb-4">
                <div className="card-body p-4 p-md-5 text-center">
                  <div className="tracking-qr-header mb-4">
                    <h2 className="tracking-details-title mb-2">QR Code</h2>
                    <p className="tracking-live-map-subtitle mb-0">
