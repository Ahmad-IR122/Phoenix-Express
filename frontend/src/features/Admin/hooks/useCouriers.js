    ...
    return [
      {
        ...
        note: "إجمالي عدد المناديب المسجلين حاليًا.",
        icon: "bi-people",
      ...
      },
      {
        ...
        note: "المناديب الجاهزون لاستلام طلبات جديدة.",
      ...
      },
      {
        ...
        note: "المناديب الذين لديهم ضغط تشغيلي أعلى حاليًا.",
        icon: "bi-truck",
      ...
      },
      {
        ...
        note: "المناديب غير المتاحين للتشغيل في الوقت الحالي.",
        icon: "bi-person-x",
      ...
      },
      {
        ...
        note: "إجمالي الطلبات التي تم تسليمها بنجاح.",
      ...
      },
      {
        ...
        note: "إجمالي المبالغ المحصلة من عمليات التوصيل.",
        icon: "bi-cash-stack",
